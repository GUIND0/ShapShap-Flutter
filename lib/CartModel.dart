...
final String tableName = "mycart";
final String database = "base.db";
...
class CartModel{
  ...
  CartModel({this.seller_id,this.buyer_id,this.product_id,this.quantity,this.url,this.price,this.name});
...
class CartHelper {
  ...
  Future<void> insertTask(CartModel cart) async {
    try {
  ...
  Future<List<CartModel>> getModels() async {
    // Get a reference to the database.
